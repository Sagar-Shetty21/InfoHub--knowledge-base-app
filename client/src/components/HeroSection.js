...
const HeroSection = () => {
    return (
        <div className="flex flex-col items-center justify-center py-20 gap-6">
            <div className="text-3xl text-white font-semibold text-center mt-10">A Knowledge Sharing Platform</div>
            <div className="text-white text-center">Bringing together all the information about common concepts in the world of web technology.</div>
